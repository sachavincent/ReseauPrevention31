...
--
-- Hôte : localhost:8889
-- Généré le :  lun. 11 mai 2020 à 11:01
...
CREATE TABLE `Utilisateur` (
  ...
  `demande` enum('EN_COURS','VALIDE','REFUSE') NOT NULL DEFAULT 'EN_COURS',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `Conseil`
  MODIFY `idConseil` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `FilDeDiscussion`
--
ALTER TABLE `FilDeDiscussion`
  MODIFY `idFilDeDiscussion` int(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `ForceDeLOrdre`
--
ALTER TABLE `ForceDeLOrdre`
  MODIFY `idForce` int(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12346;
...
--
ALTER TABLE `MessagePrive`
  MODIFY `idMessagePrive` int(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT pour la table `Utilisateur`
--
ALTER TABLE `Utilisateur`
  MODIFY `idUtilisateur` int(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
