...
public class AnciennesAnnoncesFragment extends ViewPagerFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_old_announcement, container, false);
    ...
    void initRecycler() {
        ...
        // Initialise le recycler
        RecyclerView recycler = mView.findViewById(R.id.recyclerOldAnnouncements);
    ...
    public void refreshRecycler() {
        ...
        mAnnonces.addAll(MainActivity.sDatabaseHelper.getOldAnnouncements());
