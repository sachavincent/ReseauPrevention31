...
<div id="barre-actions">
  ...
  <input class="actions" type="button" value="accepter" onclick="window.location.href='../script/gestionBoutons.php?e=attente&m=<?= $_GET['m'] ?>&b=accepter'" />
  <input class="actions" type="button" value="refuser" onclick="window.location.href='../script/gestionBoutons.php?e=attente&m=<?= $_GET['m'] ?>&b=refuser'" />
</div>
