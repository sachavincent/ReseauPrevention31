...
if (!empty($_SESSION[$onglet])) {
    ...
    for ($i = 0; $i < $nb; $i++) {
        ...
        $onglet_affiche        = $date . '<h9>' . trunc($nomPrenom, 15) . '</h9><br>' . '<h10>' . trunc($affiche['nomSociete'], 18) . ', ' . 'secteur ' . $affiche['secteur'] . '</h10>';
        $onglet_affiche_clique = $date . '<h9>' . trunc($nomPrenom, 15) . '</h9><br>' . '<h10>' . trunc($affiche['nomSociete'], 18) . ', ' . 'secteur ' . $affiche['secteur'] . '</h10>';
