...
<div id="barre-actions">
  ...
  <!-- actions rapides -->
  <img class="refresh-rapide" src="../images/refresh.png" onclick="window.location.href='demandes.php?e=annonce&m=none'"/>
  <!-- actions de la demande ouverte -->
  <input class="actions" type="button" value="supprimer" onclick="window.location.href='../script/gestionBoutons.php?e=annonce&m=<?php echo $_GET['m'] ?>&b=supprimer'"/> 
</div>
